    ...
    <>
      ...
      <body>
        ...
        <p className="about-info">
          Hi guys! I tried my best to make this as not ugly as possible. Hope
          you like it.
        </p>
        ...
        <p>
          I decided to just include my Receiptify, which compiles your current
          top ten songs on Spotify.
        </p>
        <div className="image-container">
          <img
